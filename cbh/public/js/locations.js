...
var locations = [
	...
	['108 Jacobson Road', 'St. Catharines, ON', '$1000', 43.1354108, -79.2275716, globalPropertyDetailUrl, shortGlobalImgUrl.concat('/uploads/56444027de74d/house picture.jpg'), globalImgUrl.concat("/property-types/home.png")], 
	['2533 thorne lodge drive', 'mississauga, ON', '$22', 43.5260902, -79.6738011, globalPropertyDetailUrl, shortGlobalImgUrl.concat('/uploads/564441f83b01f/2.PNG'), globalImgUrl.concat("/property-types/home.png")], 
	['81 Winterberry Blvd', 'Thorold, ON', '$375', 43.1170321, -79.2276325, globalPropertyDetailUrl, shortGlobalImgUrl.concat('/uploads/56444826ef0ce/modern pool.jpg'), globalImgUrl.concat("/property-types/home.png")]
];