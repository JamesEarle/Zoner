            ...
            <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                <?php 
                    ...
                    switch(Session::get('message')) {
                        case 'email-in-use':
                            echo '<h2 class="error">It seems that email is in use, please try again.</h2>';
                            break;
                        case 'confirm':
                            echo '<h2 class="error">Please correctly confirm your password.</h2>';
                            break;
                        case 'alt':
                            echo '<h2 class="error">We\'ve encountered an error, please try again later.</h2>';
                            break;
                    }
                ?>
                <h3>Account Type</h3>
